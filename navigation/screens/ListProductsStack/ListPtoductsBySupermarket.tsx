...
import { listProductBanner } from "../../../component/idAdmob";
  ...
  const ListProductsBySupermarket = ({ route }) => {
    ...
    const supermarketImages = {
      ...
      HyperIntermarche:"https://play-lh.googleusercontent.com/y8py7OoxNFqBibg-CZrmIACpVLocBOa7yy3U4F3S8G6Fqjljb7g8w-y4WhaGKtAbKzk",
      SuperIntermarche:"https://play-lh.googleusercontent.com/y8py7OoxNFqBibg-CZrmIACpVLocBOa7yy3U4F3S8G6Fqjljb7g8w-y4WhaGKtAbKzk",
  ...
  const styles = StyleSheet.create({
    ...
    checkboxContainer: {
      alignItems: "center",
      borderColor: "#1E262F", // Set the border color to black
